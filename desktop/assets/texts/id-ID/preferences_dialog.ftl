...
log-filename-pattern = Nama berkas Log
...
gamemode = GameMode
gamemode-tooltip = GameMode menambahkan optimisasi secara sementara pada komputer Anda dan/atau Ruffle. Ruffle hanya meminta ModePermainan apabila sebuah SWF sedang dimainkan.
