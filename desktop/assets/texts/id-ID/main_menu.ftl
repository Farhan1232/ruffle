...
file-menu = Berkas
file-menu-open-file = Buka Berkas...
file-menu-open-directory = Buka Folder...
file-menu-open-advanced = Buka dengan opsi lanjutan...
file-menu-close = Tutup
file-menu-reload = Muat ulang
file-menu-recents = Terbaru
file-menu-recents-empty = Tidak ada entri terbaru
file-menu-preferences = Pengaturan...
file-menu-exit = Keluar
file-menu-export = Ekspor...
controls-menu = Kontrol
controls-menu-suspend = Tunda
controls-menu-resume = Lanjut
controls-menu-step-once = Langkah Tunggal
...
bookmarks-menu = Penanda
bookmarks-menu-add = Tambah...
bookmarks-menu-manage = Atur Penanda...
debug-menu = Alat debug
debug-menu-open-stage = Lihat info halaman
debug-menu-open-root-movie-clip = Tunjukan MovieClip Utama
...
view-menu = Tampilan
view-menu-fullscreen = Layar Penuh
