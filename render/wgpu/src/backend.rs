        ...
        Some(RenderMemoryUsage {
            ...
            work: {
                ...
                RenderWorkUsage {
                    ...
                    multiply_on_draw_used: work.multiply_on_draw_used,
                    multiply_on_draw_shape: work.multiply_on_draw_shape,
                    multiply_on_draw_transparent: work.multiply_on_draw_transparent,
